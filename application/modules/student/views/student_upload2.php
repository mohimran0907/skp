<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			<?php echo "Import Data Santri" ?>
		</h1>
		<ol class="breadcrumb">
			<li><a href="<?php echo site_url('manage') ?>"><i class="fa fa-th"></i> Home</a></li>
			<li class="active"><?php echo "import data santri" ?></li>
		</ol>
	</section>
			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body table-responsive">
						...
						<p>Penginputan data Santri bisa dilakukan dengan mengcopy data dari file Ms. Excel. Format file excel harus sesuai kebutuhan aplikasi. Silahkan download formatnya <a href="<?php echo site_url('manage/student/download'); ?>"><span class="label label-success">Disini</span></a>
							<br><br>
