				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="col-sm-10">
							...
							<?php } ?>
							<a class="btn btn-info btn-sm" href="<?php echo site_url('manage/payment/add_payment_bebas_student/' . $payment['payment_id']) ?>"><span class="glyphicon glyphicon-plus"></span> Berdasarkan Santri</a>
